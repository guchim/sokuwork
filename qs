...
db="database" # describe database service name from docker-compose.yml
...
create_project() {
  ...
  bundle_exec rails new . -f --skip-turbolinks -d=$db_option$front_option$test_option$api_option
